...
import { EDIT_GUIDANCE, READ_GUIDANCE, UNDO_GUIDANCE, type ToolGuidance } from "../prompts.js";
...
function overrideCandidates(file: string, options: ResolveGuidanceOptions): string[] {
